...
(function( $ ) {
	...
	var dates = $.fn.datepicker.dates = {
		en: {
			days: ["Pazar", "Pazartesi", "Sali", "Carsamba", "Persmbe", "Cuma", "Cumartesi", "Pazar"],
			daysShort: ["Paz", "Pzt", "Sal", "Crs", "Prs", "Cum", "Cmt", "Paz"],
			daysMin: ["Pa", "Pt", "Sa", "Cs", "Ps", "Cm", "Ct", "Pa"],
			months: ["Ocak", "Subat", "Mart", "Nisan", "Mayis", "Haziran", "Temmuz", "Agustos", "Eylul", "Ekim", "Kasim", "Aralik"],
			monthsShort: ["Ock", "Sbt", "Mar", "Nis", "May", "Haz", "Tem", "Agu", "Eyl", "Eki", "Kas", "Ara"],
			today: "Bugun",
			clear: "Clear"
		}
	};
